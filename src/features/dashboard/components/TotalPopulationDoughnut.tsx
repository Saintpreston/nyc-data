...
//   const datasets: any = [{data:[]}]
  ...
  const donutData = {
    labels: ["Asian","Black","Two or More", "Other", "White", "Native American"],
   datasets: [{
    data:[demographics!.asian,demographics!.black,demographics?.twoOrMore,demographics?.other,demographics?.white,demographics?.nativeAmerican],
    backgroundColor: [
     'rgba(255, 99, 132, 0.2)',
     'rgba(54, 162, 235, 0.2)',
     'rgba(255, 206, 86, 0.2)',
